...
| Case                     | Category               | Path                                                  | Auth                             | Assertions             | Processors | Notes                                                                                                                                |
| ------------------------ | ---------------------- | ----------------------------------------------------- | -------------------------------- | ---------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| Success                  | Positive               | A disposable throwaway user's id (register one first) | `{{adminToken}}`                 | `Status=200`; `RV@200` | `None`     | Never run against the seeded regular user (`test@eshop.com`) or your main admin account.                                             |
